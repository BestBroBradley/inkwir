...
useEffect(() => {
  ...
  const result = (results[0] ? results[0].results : "")
  // const fullResult = (result)
  // const survey = (surveys[0] ? surveys[0].title : "");

  console.log(results);

  const title = (surveys[0] ? surveys[0].title : "");

  const questions = (surveys[0] ? surveys[0].questions : "");
